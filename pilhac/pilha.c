...
int pop(pilha *variavel_pilha) /*Remover o elemento do topo da pilha.*/
{
	int variavel;
...
int peek(pilha *variavel_pilha) /*Peek: Inspecionar o elemento do topo da pilha mas sem remover.*/
{
